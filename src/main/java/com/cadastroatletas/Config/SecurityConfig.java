...
public class SecurityConfig {
    ...
    @Autowired
    private SecurityFilter securityFilter; // Vamos criar essa classe já já
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/auth/register").permitAll() // Registro livre (opcional)
